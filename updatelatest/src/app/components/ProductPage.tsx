...
//   // Single image from product.imagePath
//   const [selectedImage] = useState(product.image || "/default-image-path.jpg");

//   const { addToCart } = useCart();
//   const { addToWishlist, removeFromWishlist, isInWishlist } = useWishlist();

//   // Compute discounted price if needed
//   const hasDiscount = product.discountPercentage > 0;
//   const finalPrice = Math.round(
//     product.price * (1 - product.discountPercentage / 100)
//   );
...
//   const handleAddToCart = () => {
//     addToCart({
//       id: product.id, // schema has id as string
//       name: product.name,
//       price: hasDiscount ? finalPrice : product.price,
//       image: product.image || "", // pass the single image URL
//     });
//   };
...
//           </p>
//           {/* If you fetch category->{title} in GROQ, you can display it here */}
//           {/* <p>
//             <span className="font-semibold">Category:</span> {product.category?.title}
//           </p> */}
//           <p>
